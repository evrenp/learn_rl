...
constructor_kwargs_list = [
    ...
    (SarsaMaxFunctionApproximationAgent, dict(env=env, epsilon=0.5, gamma=1.0, feature_creation='scaling')),
    (SarsaMaxFunctionApproximationAgent, dict(env=env, epsilon=0.5, gamma=1.0, feature_creation='scaling_and_rbf')),
]
